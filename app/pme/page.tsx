    ...
    <div style={{ minHeight: "100vh", background: FOND, color: "#fff", fontFamily: "Georgia, serif" }}>
      ...
      <section style={{ background: "linear-gradient(135deg,#0a0a1a,#1a1a2e)", padding: "70px 24px", textAlign: "center" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "17px", lineHeight: 1.75, maxWidth: "680px", margin: "0 auto 30px" }}>
          Vous cotisez chaque annee a un operateur de competences. Devenez votre
          propre organisme de formation, formez vos equipes en interne, et
      ...
      <section style={{ maxWidth: "820px", margin: "0 auto", padding: "30px 24px 20px" }}>
        ...
        <div style={{ background: CARTE, border: "1px solid rgba(200,169,110,0.25)", borderRadius: "13px", padding: "24px", marginBottom: "16px" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "14.5px", lineHeight: 1.8, margin: 0 }}>
            ...
            encore. Vous gardez la main sur votre declaration d activite et sur
            votre certification.
          </p>
        </div>
        ...
        <div style={{ background: CARTE, border: "1px solid rgba(200,169,110,0.25)", borderRadius: "13px", padding: "24px" }}>
          ...
          <h3 style={{ color: "#fff", fontSize: "19px", margin: "0 0 12px" }}>Vous formez vos salaries</h3>
          <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "14.5px", lineHeight: 1.8, margin: 0 }}>
      ...
      <section style={{ maxWidth: "820px", margin: "0 auto", padding: "30px 24px 20px" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "14px", margin: "0 0 20px", lineHeight: 1.75 }}>
          Plus de trois cents parcours, adaptables a vos metiers.
        </p>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: "14px" }}>
          {[
            { t: "Securite et prevention", d: "Securite au poste et sur chantier, gestes et postures, risques chimiques, travail en hauteur" },
            { t: "Management et encadrement", d: "Encadrement d equipe, conduite du changement, entretiens difficiles, motivation" },
            { t: "Numerique et intelligence artificielle", d: "Outils IA, automatisation, bureautique, cybersecurite" },
            { t: "Savoirs de base et integration", d: "Lecture de consignes, calculs professionnels, accueil des nouveaux, savoir-etre" },
            { t: "Commerce et relation client", d: "Vente, negociation, prospection, communication professionnelle" },
            { t: "Gestion et finance", d: "Comptabilite, fiscalite, tableaux de bord, pilotage de la performance" },
          ].map(function (x) {
            return (
      ...
      <section style={{ maxWidth: "820px", margin: "0 auto", padding: "30px 24px 50px" }}>
        <div style={{ background: "rgba(200,169,110,0.06)", border: "1px solid rgba(200,169,110,0.3)", borderRadius: "13px", padding: "26px" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "15px", lineHeight: 1.8, margin: "0 0 14px" }}>
            La certification Qualiopi n est ni immediate ni gratuite : elle suppose
            un audit initial, un audit de surveillance et un renouvellement tous les
            trois ans, ainsi que des indicateurs a tenir dans la duree. Comptez
            plusieurs mois avant votre premiere prise en charge.
          </p>
          <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "15px", lineHeight: 1.8, margin: "0 0 14px" }}>
            Les regles de prise en charge dependent de votre branche et de votre
            operateur de competences. Nous vous aidons a y voir clair, mais la
            decision de financement leur appartient.
          </p>
          <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "13.5px", lineHeight: 1.75, margin: 0 }}>
            ...
            enregistrees ni au Repertoire national des certifications
            professionnelles ni au repertoire specifique. Nous fournissons le
            logiciel, le contenu et la plateforme ; la certification, la declaration
            d activite et la responsabilite pedagogique demeurent les votres. Nous
      ...
      <section id="rendez-vous" style={{ maxWidth: "620px", margin: "0 auto", padding: "10px 24px 80px" }}>
        ...
        <div style={{ background: CARTE, borderRadius: "14px", padding: "28px", border: "1px solid rgba(200,169,110,0.3)" }}>
          ...
          <span style={lib}>Combien de salaries</span>
          <select value={effectif} onChange={function (e) { setEffectif(e.target.value); }} style={champ}>
            ...
            <option value="50 a 250">50 a 250</option>
          ...
          <select value={secteur} onChange={function (e) { setSecteur(e.target.value); }} style={champ}>
            ...
            <option value="Sante et social">Sante et social</option>
