...
const FR = {
  ...
  sousTitre: "Satisfait ou rembourse · sans conditions",
  champs: { email: "Email de votre compte",
    reference: "Reference de commande",
    raison: "Raison de votre demande" },
  bouton: "Demander le remboursement",
  bas: "Remboursement sous 48h · contact@academiapro.fr",
};
    ...
    <div style={{ minHeight: "100vh", background: "#050508",
      ...
      <div style={{ maxWidth: "600px",
        ...
        <div style={{ background: "#1a1a2e",
          ...
          border: "1px solid rgba(200,169,110,0.3)" }}>
          {[
            txt.champs.email, txt.champs.reference,
            txt.champs.raison,
          ].map((libelle, i) => (
