...
const LM = {
  fr: { coach_btn: "Acceder a ma formation", classe_btn: "Rejoindre une Classe Live", objectifs: "Objectifs", prerequis: "Prérequis", public_cible: "Public cible", programme: "Programme complet", pret: "Pret a commencer ?", acces: "Accès immédiat · Agent IA 24h/24 · Garantie 30 jours", acheter: "Acheter", niveau: "Niveau", elearning: "E-Learning", elearning_sub: "Asynchrone · A votre rythme", coach: "Coach IA 24h/24", coach_sub: "Questions par chat · Immediat", classe: "Classe Virtuelle", classe_sub: "Live · Mardis et Jeudis 20h", titre: "Accédez aux 2 premiers modules gratuitement", sub: "Laissez vos coordonnées et découvrez la formation", btn: "Je veux acceder gratuitement", prenom: "Votre prenom *", email: "Votre email *", mobile: "Téléphone mobile", fixe: "Téléphone fixe / bureau", acceder: "Accéder maintenant", merci: "Bienvenue ! Vos coordonnées ont été enregistrées.", support: "Support de cours", support_sub: "Document complet · 300+ pages", voir: "Voir le support" },
