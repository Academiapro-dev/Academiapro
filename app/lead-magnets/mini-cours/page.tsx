...
const FR = {
  ...
  titre: "Mini-cours Gratuit 3 Jours",
  sousTitre: "Maitriser Claude en 15 minutes par jour",
  champs: { prenom: "Prenom", email: "Email",
    metier: "Metier" },
  bouton: "Commencer le mini-cours gratuitement",
  bas: "Jour 1 : premier prompt · Jour 2 : automatiser · Jour 3 : agent IA",
};
