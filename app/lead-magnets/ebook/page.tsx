...
export async function POST(req: NextRequest) {
  try {
    ...
    // PAS D OPTION download : sur iPad, un lien qui force le telechargement
    // ouvre un onglet blanc. Sans elle, le PDF s affiche dans le lecteur et
    // se garde par le bouton de partage.
