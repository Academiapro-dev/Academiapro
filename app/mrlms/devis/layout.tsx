// ══════════════════════════════════════════════════════════════════════════
// LE DEVIS MR LMS N EST PAS INDEXE — 04/09.
//
...
// layout que Next.js applique a toutes les pages du dossier /mrlms/devis.
//
...
export default function LayoutDevisMrLMS({ children }: any) {
  return children;
}
