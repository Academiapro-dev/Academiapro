  ...
  return (
    <div style={{ minHeight: "100vh", background: FOND, color: "#fff", fontFamily: "Georgia, serif" }}>
      ...
      <section style={{ background: "linear-gradient(135deg,#0a0a1a,#1a1a2e)", padding: "70px 24px", textAlign: "center" }}>
        <p style={{ color: OR, fontSize: "13px", letterSpacing: "3px", margin: "0 0 14px" }}>SOCIÉTÉS DE SERVICES DU NUMÉRIQUE</p>
        <h1 style={{ fontSize: "34px", margin: "0 0 18px", lineHeight: 1.3, maxWidth: "780px", marginLeft: "auto", marginRight: "auto" }}>
          Formez vos consultants avec<br />le budget qui existe déjà
        </h1>
        <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "17px", lineHeight: 1.75, maxWidth: "680px", margin: "0 auto 30px" }}>
          Votre branche cotise à l'OPCO Atlas. Devenez votre propre organisme de
          formation, formez vos équipes en interne, et mobilisez ces fonds au lieu
      ...
      <section style={{ maxWidth: "820px", margin: "0 auto", padding: "60px 24px 20px" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "15.5px", lineHeight: 1.85, margin: "0 0 16px" }}>
          ...
          académie interne. Les plus petites y renoncent, parce que la certification
      ...
      <section style={{ maxWidth: "820px", margin: "0 auto", padding: "30px 24px 20px" }}>
        ...
        <div style={{ background: CARTE, border: "1px solid rgba(200,169,110,0.25)", borderRadius: "13px", padding: "24px", marginBottom: "16px" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "14.5px", lineHeight: 1.8, margin: 0 }}>
            ...
            encore. Vous gardez la main sur votre déclaration d'activité et sur votre
            certification.
          </p>
        </div>
      ...
      <section style={{ maxWidth: "820px", margin: "0 auto", padding: "30px 24px 20px" }}>
        <h2 style={{ color: OR, fontSize: "24px", margin: "0 0 8px" }}>Ce que votre catalogue couvre déjà</h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: "14px" }}>
          {[
            { t: "Intelligence artificielle", d: "Claude et IA générative, no-code et automatisation, applications natives, IA appliquée aux métiers" },
            { t: "Cybersécurité", d: "Fondamentaux, préparation aux référentiels du marché, pratiques offensives et défensives" },
            { t: "Management", d: "Encadrement d'équipe, conduite du changement, entretiens difficiles, management à distance" },
            { t: "Relation client et posture", d: "Savoir-être en mission, conduite de réunion, communication professionnelle" },
          ].map(function (x) {
            return (
      ...
      <section style={{ maxWidth: "820px", margin: "0 auto", padding: "30px 24px 50px" }}>
        <div style={{ background: "rgba(200,169,110,0.06)", border: "1px solid rgba(200,169,110,0.3)", borderRadius: "13px", padding: "26px" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "15px", lineHeight: 1.8, margin: "0 0 14px" }}>
            La certification Qualiopi n'est ni immédiate ni gratuite : elle suppose un
            audit initial, un audit de surveillance et un renouvellement tous les trois
            ans, ainsi que des indicateurs à tenir dans la durée. Comptez plusieurs mois
            avant votre première prise en charge.
          </p>
          <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "13.5px", lineHeight: 1.75, margin: 0 }}>
            ...
            enregistrées ni au Répertoire national des certifications professionnelles
            ni au répertoire spécifique. Nous fournissons le logiciel, le contenu et la
            plateforme ; la certification, la déclaration d'activité et la
            responsabilité pédagogique demeurent les vôtres. Nous ne garantissons
      ...
      <section id="rendez-vous" style={{ maxWidth: "620px", margin: "0 auto", padding: "10px 24px 80px" }}>
        ...
        <div style={{ background: CARTE, borderRadius: "14px", padding: "28px", border: "1px solid rgba(200,169,110,0.3)" }}>
          ...
          <span style={lib}>Votre société</span>
          ...
          <select value={effectif} onChange={function (e) { setEffectif(e.target.value); }} style={champ}>
            ...
            <option value="50 a 150">50 à 150</option>
            <option value="150 a 300">150 à 300</option>
