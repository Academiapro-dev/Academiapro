    ...
    <div style={CADRE}>
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "14px", marginTop: 0 }}>
          Signature electronique simple au sens du reglement europeen eIDAS
        </p>
            ...
            {d.alterees > 0 && (
              <div style={{ ...CARTE, border: "1px solid rgba(232,131,106,0.6)" }}>
                <p style={{ color: "#e8836a", fontSize: "15px", margin: 0, lineHeight: "1.75" }}>
                  {d.alterees} signature(s) portent un sceau qui ne correspond plus a leur contenu.
                  Cela signifie que la ligne a ete modifiee en base apres la signature. Ces
                  signatures ne doivent pas etre opposees a un tiers.
                </p>
              </div>
            )}
                  ...
                  <div key={s.id} style={{ ...CARTE, border: "1px solid " + (s.intacte ? "rgba(76,175,80,0.35)" : "rgba(232,131,106,0.6)"), opacity: s.annulee ? 0.5 : 1 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "10px" }}>
                      ...
                      <div style={{ textAlign: "right" }}>
                        <p style={{ color: s.intacte ? "#4caf50" : "#e8836a", fontSize: "13px", fontWeight: "bold", margin: "0 0 2px" }}>
                          {s.annulee ? "Annulee" : s.intacte ? "Sceau verifie" : "Sceau altere"}
                        </p>
                    ...
                    {estOuvert && (
                      <div style={{ marginTop: "16px", paddingTop: "14px", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
                        ...
                        <p style={ETIQUETTE}>Empreinte SHA-256 du document signe</p>
                        <p style={{ ...VALEUR, fontFamily: "monospace", fontSize: "12px" }}>
                          {s.empreinte_sha256}
                        </p>

                        <p style={ETIQUETTE}>Adresse de connexion</p>
                        <p style={VALEUR}>{s.adresse_ip || "non enregistree"}</p>

                        <p style={ETIQUETTE}>Navigateur declare</p>
                        <p style={{ ...VALEUR, fontSize: "12px" }}>{s.navigateur || "non enregistre"}</p>

                        <p style={ETIQUETTE}>Texte accepte par le signataire</p>
                        ...
                        <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "12px", margin: "12px 0 0", lineHeight: "1.7" }}>
                          Ce sceau est calcule sur l ensemble des elements ci-dessus. Toute
                          modification, meme d un seul caractere, le rendrait invalide — c est
