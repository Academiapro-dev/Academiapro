...
const EXEMPLE = `MANDAT DE VENTE NON EXCLUSIF

Entre les soussignés :

{{nom}}, demeurant {{adresse}}, {{code_postal}} {{ville}}, ci-après le Mandant,

Et l'agence, ci-après le Mandataire,

Il a été convenu ce qui suit.

Article 1 — Objet
Le Mandant confie au Mandataire la vente du bien situé {{adresse_bien}}, au prix de {{prix}} euros net vendeur.

Article 2 — Honoraires
Les honoraires du Mandataire s'élèvent à {{honoraires}} euros, à la charge de {{charge_honoraires}}.

Article 3 — Durée
Le présent mandat est consenti pour une durée de {{duree}} mois à compter de sa signature.
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        ...
        {ouvert && (
          <div style={CARTE}>
            ...
            />
            {corps.length === 0 && (
              <button onClick={() => setCorps(EXEMPLE)} style={{ ...SECOND, marginBottom: "14px" }}>
                Partir d&apos;un exemple
              </button>
            )}
