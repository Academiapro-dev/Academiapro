...
export async function GET(req: Request) {
  ...
  try {
    ...
    let html = await fichier.text();
    html = html.replace(/Support de cours officiel/gi, "Manuel de formation");
    ...
    const pdf = await page.pdf({
      ...
      footerTemplate:
        '<div style="font-size:9px;width:100%;text-align:center;color:#999;font-family:Georgia,serif;">' +
