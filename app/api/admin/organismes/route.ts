...
export async function GET() {
  try {
    ...
    // Nombre de stagiaires inscrits par organisme, pour voir d un coup d oeil
    // qui a commence a s en servir et qui n a rien fait.
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Le tenant_id se genere tout seul : c est lui que porteront ensuite
    // le registre des stagiaires et leurs sessions.
