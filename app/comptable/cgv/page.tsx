...
export const metadata = {
  title: "Conditions générales de vente — Mr. Comptable",
};
...
// Le texte vit en base, pas dans le code : une correction juridique se fait
// par SQL, sans redeploiement et sans passer par GitHub.
export default async function CgvComptable() {
