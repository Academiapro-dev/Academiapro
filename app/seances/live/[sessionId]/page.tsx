export default function SeanceLivePage({ params }: { params: { sessionId: string } }) {
  return (
    <div style={{ minHeight: "100vh", background: "#050508", color: "#fff", fontFamily: "Georgia, serif", display: "flex", flexDirection: "column" }}>
      <div style={{ background: "#0d0d14", borderBottom: "1px solid rgba(200,169,110,0.25)", padding: "0 24px", height: "60px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <span style={{ color: "#c8a96e", fontWeight: "bold" }}>AcadémIA Pro · Seance Visio</span>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "40px" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <h2 style={{ color: "#c8a96e", fontSize: "24px", margin: "0 0 8px" }}>Seance Visio en Cours</h2>
          <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "15px", margin: "0 0 8px" }}>Integration HeyGen · Daily.co en cours de configuration</p>
