...
// Celui-ci travaille des CLIENTS DEJA SIGNES : des gens a relancer. La
// difference change tout le vocabulaire, mais pas la mecanique — cartes de
// compteurs, filtres rapides, tableau paginé, fiche depliable.
//
// 🚨 CE QUE LE CABINET FAIT AU TELEPHONE, DOSSIER PAR DOSSIER. Un
// collaborateur passe ses journees a reclamer : une facture manquante, un
// justificatif de depense bancaire, une note de frais sans recu. Cet ecran
// rassemble ces demandes et les envoie en un geste.
//
...
export default function CRMCabinet() {
  ...
  // La relance en preparation.
  const [brouillon, setBrouillon] = useState<any>(null);

  // Le contact en cours de saisie.
  ...
  // PREPARER PUIS ENVOYER, EN DEUX TEMPS.
  //
  // Le texte revient a l ecran avant de partir : une relance s envoie au
  // nom du cabinet, a son propre client. Elle se relit.
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "14px" }}>
          <div>
            ...
            <p style={{ color: "rgba(255,255,255,0.5)", margin: "5px 0 0", fontSize: "13px" }}>
              Mes clients · leurs contacts · mes relances
            </p>
          </div>
          {c && c.a_relancer > 0 && (
            <div
            ...
            <div style={{ ...CARTE, border: "1px solid rgba(232,131,106,0.3)" }}>
              ...
              {c.a_relancer === 0 ? (
                ...
                <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "13.5px", lineHeight: "1.8", margin: 0 }}>
                  ...
                  Chaque relance envoyée d'ici débloque une révision.
                </p>
              )}
            </div>
                    ...
                    {visibles.map(function (x: any, i: number) {
                      ...
                      return (
                        <tr key={x.id} style={{ background: fond }}>
                          ...
                          <td style={TD}>
                            <button onClick={() => { setOuverte(ouverte === x.id ? "" : x.id); setOnglet("relances"); }}
        ...
        {onglet === "relances" && d && (
          <div>
            <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "13.5px", lineHeight: "1.8", margin: "0 0 16px" }}>
              Les dossiers qui attendent quelque chose de leur client. Choisissez le motif :
              le message se prépare, vous le relisez, et il part par courriel ou par SMS.
            </p>
                ...
                return (
                  <div key={x.id} style={{ ...CARTE, border: ouvert ? "1px solid rgba(200,169,110,0.5)" : CARTE.border }}>
                    <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "10px" }}>
                      ...
                      <button onClick={() => setOuverte(ouvert ? "" : x.id)} style={{ ...BOUTON, alignSelf: "flex-start" }}>
                    ...
                    {!x.joignable && (
                      <div style={{ marginTop: "10px", padding: "10px 12px", background: "rgba(232,131,106,0.1)", border: "1px solid rgba(232,131,106,0.3)", borderRadius: "8px", color: ROUGE, fontSize: "12.5px", lineHeight: "1.7" }}>
                        Aucun contact enregistré sur ce dossier. Ajoutez-en un ci-dessous.
                      </div>
                    )}
