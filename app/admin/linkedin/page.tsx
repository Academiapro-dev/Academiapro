...
function messageRelance(prenom: string, societe: string, nbFormations: number, cle?: string) {
  ...
  if (k === "mrcrm") {
    return salut
      ...
      + "intéressé, client — et vous le déplacez d'un geste. Ce qui s'est dit "
      + "au téléphone, ce que vous avez promis, la date à laquelle rappeler : "
      + "tout reste sur sa fiche.\n\n"
  ...
  if (k === "mrlms") {
    return salut
      ...
      + "ont leurs propres formations : les inscriptions, les documents qui se "
      + "signent, les évaluations, les réclamations et le bilan pédagogique "
  ...
  return salut
    + "Merci d'avoir accepté mon invitation.\n\n"
    + "Je mets à disposition des organismes de formation un catalogue de "
    + combien + " formations professionnelles, que vous proposez sous votre "
    + "nom et à vos prix. Vous n'avez rien à concevoir, rien à rédiger : les "
    + "contenus, les questionnaires et les supports existent.\n\n"
    + "Les contenus sont construits sur les référentiels métier. Un stagiaire "
    + "qui va au bout de son parcours dispose ensuite de ce qu'il faut pour se "
    + "présenter en candidat libre à une certification professionnelle, s'il "
    + "le souhaite — cette démarche lui appartient, nous ne la conduisons pas "
    + "et ne la garantissons pas, mais nous pouvons lui indiquer où se "
    + "renseigner.\n\n"
    + "C'est une façon d'élargir ce que vous proposez sans y passer vos "
    + "soirées.\n\n"
    + "Si c'est un sujet chez vous, je vous montre le catalogue en trente "
    + "minutes.\n\n"
    + "Bien à vous,\nJacques Lalou\nacademiapro.fr";
}
