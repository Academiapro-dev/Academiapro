    ...
    <div style={{ background: "#050508", minHeight: "100vh", color: "#fff" }}>
      ...
      <div style={{ background: "linear-gradient(135deg,#0a0a1a,#1a1a2e)", padding: "30px", borderBottom: "2px solid rgba(200,169,110,0.3)" }}>
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          ...
          <h1 style={{ color: "#fff", fontFamily: "Georgia,serif", fontSize: "28px", margin: "0 0 6px" }}>🎓 Mr Qualiopi</h1>
          <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "14px", margin: 0 }}>Expert Certification et Qualite Formation — AcademiA Pro</p>
        </div>
      </div>
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "20px" }}>
        ...
        <div style={{ display: "flex", gap: "10px", alignItems: "center", flexWrap: "wrap" }}>
          ...
          <input
            ...
            placeholder="Posez votre question Qualiopi..."
