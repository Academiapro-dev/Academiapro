    ...
    <div style={{ minHeight: "100vh", background: "#050508", color: "#fff", fontFamily: "Georgia, serif", padding: "40px 20px" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          ...
          <h1 style={{ color: "#fff", fontSize: "32px", margin: "0 0 8px" }}>Rapport Marketing</h1>
          <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "15px", margin: "0" }}>Rapport hebdomadaire performances marketing</p>
        </div>
