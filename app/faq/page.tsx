...
export default function FaqPage() {
  ...
  const questions = [
    ...
    { q: "Puis-je acceder depuis mobile ?", r: "Oui · AcadémIA Pro est entierement responsive et disponible en PWA installable sur votre telephone." },
    ...
    <div style={{ minHeight: "100vh", background: "#050508", color: "#fff", fontFamily: "Georgia, serif", padding: "60px 20px" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          <p style={{ color: "#c8a96e", fontSize: "12px", letterSpacing: "3px", margin: "0 0 12px" }}>FAQ</p>
          <h1 style={{ color: "#fff", fontSize: "36px", margin: "0 0 12px" }}>Questions Frequentes</h1>
          <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "16px", margin: "0" }}>Toutes les reponses sur AcadémIA Pro</p>
        </div>
        ...
        <div style={{ marginTop: "48px", padding: "32px", background: "#1a1a2e", borderRadius: "16px", border: "1px solid #c8a96e", textAlign: "center" }}>
          <p style={{ color: "#c8a96e", fontSize: "16px", margin: "0 0 8px" }}>Une autre question ?</p>
          <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "14px", margin: "0 0 16px" }}>Notre equipe repond sous 24h</p>
          <a href="/contact" style={{ display: "inline-block", background: "linear-gradient(135deg, #c8a96e, #a07840)", color: "#050508", borderRadius: "8px", padding: "12px 28px", textDecoration: "none", fontWeight: "bold", fontSize: "14px" }}>Nous contacter</a>
        </div>
      </div>
    </div>
  );
