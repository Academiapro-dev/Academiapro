...
export const metadata = {
  ...
  description: "IA, formacion profesional y desarrollo de carrera",
  alternates: {
    canonical: "https://academiapro.fr/es/blog",
    languages: {
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        <div style={{ textAlign: "center",
          ...
          <p style={{ color: "rgba(255,255,255,0.6)",
            ...
            IA, formacion profesional y desarrollo de carrera
          </p>
        </div>
        {articles.length === 0 && (
