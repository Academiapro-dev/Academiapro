    ...
    <div style={{ minHeight: "100vh", background: "#050508", color: "#fff", fontFamily: "Georgia, serif" }}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "32px 20px" }}>
        <div style={{ background: "#1a1a2e", borderRadius: "16px", padding: "24px", marginBottom: "24px", border: "1px solid rgba(200,169,110,0.2)" }}>
          <input type="text" placeholder={txtT.recherche} value={recherche} onChange={(e) => { setRecherche(e.target.value); setPage(1); }} style={{ width: "100%", background: "#050508", border: "1px solid rgba(200,169,110,0.3)", borderRadius: "8px", padding: "12px 16px", color: "#fff", fontSize: "14px", marginBottom: "16px", boxSizing: "border-box" }} />
