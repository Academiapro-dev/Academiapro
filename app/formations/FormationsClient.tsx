...
const COULEURS: Record<string, string> = {
  "IA": "#c8a96e", "Business": "#4a9eff", "Marketing": "#f97316",
  "Langues": "#22c55e", "Bien-etre": "#a855f7", "Tech": "#06b6d4",
  "Design": "#ec4899", "Finance": "#eab308", "Droit": "#64748b", "Outils": "#94a3b8",
};
    ...
    <div style={{ minHeight: "100vh", background: "#050508", color: "#fff", fontFamily: "Georgia, serif" }}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "32px 20px" }}>
        <div style={{ background: "#1a1a2e", borderRadius: "16px", padding: "24px", marginBottom: "24px", border: "1px solid rgba(200,169,110,0.2)" }}>
          <input type="text" placeholder="Rechercher une formation..." value={recherche} onChange={(e) => { setRecherche(e.target.value); setPage(1); }} style={{ width: "100%", background: "#050508", border: "1px solid rgba(200,169,110,0.3)", borderRadius: "8px", padding: "12px 16px", color: "#fff", fontSize: "14px", marginBottom: "16px", boxSizing: "border-box" }} />
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            {(recherche || domaine !== "Tous" || niveau !== "Tous") && (
              <button onClick={reset} style={{ background: "transparent", color: "#c8a96e", border: "1px solid #c8a96e", borderRadius: "8px", padding: "8px 16px", fontSize: "12px", cursor: "pointer" }}>Reinitialiser</button>
            )}
          </div>
        </div>
        ...
        {totalPages > 1 && (
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "8px", marginTop: "32px" }}>
            <button onClick={() => setPage(p => Math.max(1, p - 1))} disabled={page === 1} style={{ background: page === 1 ? "#1a1a2e" : "#c8a96e", color: page === 1 ? "rgba(255,255,255,0.3)" : "#050508", border: "none", borderRadius: "8px", padding: "8px 16px", cursor: page === 1 ? "default" : "pointer", fontWeight: "bold" }}>Precedent</button>
            ...
            <button onClick={() => setPage(p => Math.min(totalPages, p + 1))} disabled={page === totalPages} style={{ background: page === totalPages ? "#1a1a2e" : "#c8a96e", color: page === totalPages ? "rgba(255,255,255,0.3)" : "#050508", border: "none", borderRadius: "8px", padding: "8px 16px", cursor: page === totalPages ? "default" : "pointer", fontWeight: "bold" }}>Suivant</button>
          </div>
        )}
        {filtrees.length === 0 && (
