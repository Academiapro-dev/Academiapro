...
const FR: Record<string, any> = {
  ...
  home: { hero_titre: "Formez-vous avec votre agent IA personnel", hero_sub: "263 formations certifiantes · Agent IA 24h/24 · Seances therapeutiques", btn_formations: "Voir les formations", btn_ebook: "E-book gratuit", stat1: "Formations certifiantes", stat2: "Competences validees", stat3: "Therapeutes IA", stat4: "Garantie satisfait" },
  ...
  footer: { desc: "La plateforme de formation propulsee par l IA. 263 formations certifiantes.", copyright: "© 2026 AcadeMIA Pro · Tous droits reserves" },
