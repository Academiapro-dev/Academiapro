...
const TRANSLATIONS: Record<string, any> = {
  fr: {
    ...
    home: { hero_titre: "Formez-vous avec votre agent IA personnel", hero_sub: "263 formations certifiantes · Agent IA 24h/24 · Séances thérapeutiques", btn_formations: "Voir les formations", btn_ebook: "E-book gratuit", stat1: "Formations certifiantes", stat2: "Compétences validées", stat3: "Thérapeutes IA", stat4: "Garantie satisfait" },
    ...
    footer: { desc: "La plateforme de formation propulsée par l IA. 263 formations certifiantes.", copyright: "© 2026 AcadémIA Pro · Certification AcadémIA Pro · Tous droits réservés" },
  ...
  en: {
    ...
    home: { hero_titre: "Learn with your personal AI agent", hero_sub: "263 certified courses · AI tutor 24/7 · Therapeutic sessions", btn_formations: "View courses", btn_ebook: "Free e-book", stat1: "Certified courses", stat2: "Validated skills", stat3: "AI Therapists", stat4: "Satisfaction guarantee" },
    ...
    footer: { desc: "The AI-powered training platform. 263 certified courses.", copyright: "© 2026 AcadémIA Pro · AcadémIA Pro Certification · All rights reserved" },
  ...
  es: {
    ...
    home: { hero_titre: "Fórmese con su agente IA personal", hero_sub: "263 cursos certificados · Tutor IA 24h · Sesiones terapéuticas", btn_formations: "Ver cursos", btn_ebook: "E-book gratis", stat1: "Cursos certificados", stat2: "Habilidades validadas", stat3: "Terapeutas IA", stat4: "Garantía satisfacción" },
    ...
    footer: { desc: "La plataforma de formación impulsada por IA. 263 cursos certificados.", copyright: "© 2026 AcadémIA Pro · Certificación AcadémIA Pro · Todos los derechos reservados" },
  ...
  ar: {
    ...
    home: { hero_titre: "تدرب مع وكيل الذكاء الاصطناعي الشخصي", hero_sub: "263 دورة معتمدة · مدرس ذكاء اصطناعي · جلسات علاجية", btn_formations: "عرض الدورات", btn_ebook: "كتاب مجاني", stat1: "دورات معتمدة", stat2: "مهارات معتمدة", stat3: "معالجون AI", stat4: "ضمان الرضا" },
    ...
    footer: { desc: "منصة التدريب المدعومة بالذكاء الاصطناعي. 263 دورة معتمدة.", copyright: "© 2026 AcadémIA Pro · شهادة AcadémIA Pro · جميع الحقوق محفوظة" },
  ...
  he: {
    ...
    home: { hero_titre: "התאמן עם סוכן הבינה המלאכותית האישי שלך", hero_sub: "263 קורסים מוסמכים · מדריך AI 24/7 · פגישות טיפוליות", btn_formations: "צפה בקורסים", btn_ebook: "ספר חינמי", stat1: "קורסים מוסמכים", stat2: "כישורים מאומתים", stat3: "מטפלים AI", stat4: "ערובת שביעות רצון" },
    ...
    footer: { desc: "פלטפורמת ההכשרה המופעלת על ידי AI. 263 קורסים מוסמכים.", copyright: "© 2026 AcadémIA Pro · הסמכת AcadémIA Pro · כל הזכויות שמורות" },
