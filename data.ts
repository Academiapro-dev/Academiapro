...
<title>data.ts - AcadémIA Pro</title>
<style>
body { margin: 0; background: #1a1a1a; color: #e0e0e0; font-family: monospace; font-size: 11px; }
#btn { position: fixed; top: 10px; right: 10px; background: #c8a96e; color: #000; border: none; padding: 10px 16px; border-radius: 8px; font-size: 14px; font-weight: bold; cursor: pointer; z-index: 999; }
pre { padding: 60px 16px 16px; white-space: pre-wrap; word-break: break-all; line-height: 1.5; }
</style>
</head>
<body>
<button id="btn" onclick="selectAll()">📋 Tout sélectionner</button>
<pre id="code">// AcadémIA Pro — Données partagées
...
export const FORMATIONS = [
  {
    code: 'F01', icon: '🏗️', titre: 'Bootcamp Product Builder No-Code &amp; IA',
    cat: 'IA &amp; No-Code', tarif: 5900, duree: '12 sem.', heures: '420h', cert: 'RNCP',
    cpf: true, opco: true, tp: true, domtom: true, handicap: true,
  ...
  {
    code: 'F02', icon: '🚀', titre: 'Bootcamp Growth Marketer IA',
    cat: 'IA &amp; No-Code', tarif: 5900, duree: '12 sem.', heures: '400h', cert: 'RNCP',
    cpf: true, opco: true, tp: true, domtom: true, handicap: true,
    description: 'Devenez Growth Marketer IA en 12 semaines. Maîtrisez SEO, Google Ads, Meta Ads, email marketing et data analytics avec l'IA. RNCP Niveau 6.',
    chapitres: [
  ...
  {
    code: 'F03', icon: '🧘', titre: 'Sophrologie Caycédienne Professionnelle',
    cat: 'Bien-être', tarif: 2800, duree: '18 mois', heures: '400h', cert: 'RS',
    cpf: true, opco: 'AFDAS', tp: false, domtom: true, handicap: true,
    description: 'Devenez Praticien en Sophrologie Caycédienne certifié RS. 400 heures sur 3 niveaux progressifs — des fondamentaux RD1-RD4 jusqu'aux 12 degrés caycédiens. Supervision mensuelle et jury de certification.',
    chapitres: [
  ...
  {
    code: 'F04', icon: '🌀', titre: 'Hypnose Ericksonienne Praticien',
    cat: 'Bien-être', tarif: 2600, duree: '12 mois', heures: '300h', cert: 'RS',
    cpf: true, opco: 'AFDAS', tp: false, domtom: true, handicap: true,
    description: 'Devenez Praticien en Hypnose Ericksonienne certifié RS. Suggestions indirectes, métaphores thérapeutiques, inductions et protocoles pour accompagner stress, confiance et performance.',
    chapitres: [
  ...
  {
    code: 'F05', icon: '🧠', titre: 'PNL Praticien &amp; Maître',
    cat: 'Bien-être', tarif: 2800, duree: '9 mois', heures: '200h', cert: 'RS',
    cpf: true, opco: 'AFDAS', tp: false, domtom: true, handicap: true,
    description: 'Devenez Praticien &amp; Maître Praticien PNL certifié RS. Présupposés PNL, calibration, rapport, métaprogrammes et techniques avancées de changement.',
    chapitres: [
  ...
  {
    code: 'F06', icon: '🔵', titre: 'Ennéagramme Professionnel',
    cat: 'Bien-être', tarif: 1800, duree: '4 mois', heures: '120h', cert: 'RS',
    cpf: true, opco: 'AFDAS', tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez l'Ennéagramme comme outil de développement personnel et professionnel certifié RS. Les 9 types, centres d'intelligence, ailes et niveaux de développement.',
    chapitres: [
      { num: 1, titre: 'Les 9 Types de Personnalité', heures: '50h', modules: [
        { num: 1, titre: 'Histoire et origines', heures: '10h', contenu: 'Histoire · 3 centres d'intelligence · Origines traditionnelles · Présentation générale' },
        { num: 2, titre: 'Les 9 ennéatypes', heures: '20h', contenu: 'Description des 9 types · Passions et vertus · Peurs fondamentales · Motivations profondes' },
      ...
      { num: 3, titre: 'Pratique Professionnelle', heures: '30h', modules: [
        { num: 1, titre: 'Accompagnement individuel', heures: '15h', contenu: 'Construction de séances · Accompagnement individuel · Ateliers collectifs · Supervision' },
  ...
  {
    code: 'F07', icon: '🔐', titre: 'Cybersécurité CompTIA Security+',
    cat: 'Métier', tarif: 3200, duree: '6 mois', heures: '300h', cert: 'CompTIA',
    cpf: true, opco: 'Atlas', tp: true, domtom: true, handicap: true,
    description: 'Devenez Technicien en Cybersécurité certifié CompTIA Security+ SY0-701 et CEH v13. 300 heures couvrant fondamentaux sécurité, pentest, SOC et gestion des incidents.',
    chapitres: [
  ...
  {
    code: 'F08', icon: '👔', titre: 'Management &amp; Leadership PMP',
    cat: 'Métier', tarif: 2000, duree: '4 mois', heures: '140h', cert: 'PMP',
    cpf: true, opco: true, tp: true, domtom: true, handicap: true,
  ...
  {
    code: 'F09', icon: '🌱', titre: 'RSE et Transition Écologique',
    cat: 'Métier', tarif: 1800, duree: '2 mois', heures: '80h', cert: 'ISO 26000',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Devenez Référent RSE certifié ISO 26000. Directive CSRD, 12 standards ESRS, bilan carbone Scope 1/2/3 et stratégie RSE opérationnelle.',
    chapitres: [
  ...
  {
    code: 'F10', icon: '📢', titre: 'Marketing Digital',
    cat: 'Métier', tarif: 2000, duree: '3 mois', heures: '100h', cert: 'Google Ads',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez le marketing digital de A à Z. SEO, Google Ads certifié, réseaux sociaux, email marketing et content marketing assisté par IA.',
    chapitres: [
  ...
  {
    code: 'F11', icon: '⚡', titre: 'Agilité &amp; Scrum Master PSM I',
    cat: 'Métier', tarif: 1800, duree: '2 mois', heures: '80h', cert: 'PSM I',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
...

  {
    ...
    cat: 'Métier', tarif: 3800, duree: '6 mois', heures: '400h', cert: 'AWS ML',
    cpf: true, opco: true, tp: true, domtom: true, handicap: true,
    description: 'Devenez Data Scientist &amp; Développeur Full Stack certifié AWS ML. Python, Machine Learning, Deep Learning, LLM &amp; Claude API, React/Next.js et MLOps.',
    chapitres: [
  ...
  {
    code: 'F13', icon: '💰', titre: 'Finance &amp; Comptabilité',
    cat: 'Métier', tarif: 2400, duree: '4 mois', heures: '200h', cert: 'DCG partiel',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
  ...
  {
    code: 'F14', icon: '🏠', titre: 'Immobilier Professionnel',
    cat: 'Métier', tarif: 2000, duree: '3 mois', heures: '120h', cert: 'Carte T prep',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Préparez-vous à la Carte T et maîtrisez la transaction immobilière. Droit immobilier, fiscalité, estimation, négociation et digital marketing avec IA.',
    chapitres: [
      ...
      { num: 2, titre: 'Transaction &amp; Estimation', heures: '45h', modules: [
        ...
        { num: 2, titre: 'Négociation et closing', heures: '25h', contenu: 'Fiscalité acquisition · Plus-values · TVA immobilière · Financement · Négociation · Closing' },
      ]},
  ...
  {
    code: 'F15', icon: '🌟', titre: 'Soft Skills &amp; Intelligence Émotionnelle',
    cat: 'Métier', tarif: 1600, duree: '2 mois', heures: '80h', cert: 'RS IE',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Développez vos compétences comportementales et votre intelligence émotionnelle certifiées RS. Communication, leadership, gestion du stress et prise de décision.',
    chapitres: [
  ...
  {
    code: 'F16', icon: '🔍', titre: 'Bilan de Compétences &amp; VAE',
    cat: 'Métier', tarif: 1200, duree: '2 mois', heures: '60h', cert: 'Attestation',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
  ...
  {
    code: 'F17', icon: '🔧', titre: 'Métiers Techniques CACES',
    cat: 'Métier', tarif: 2200, duree: '4 mois', heures: '200h', cert: 'CACES',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Obtenez les certifications CACES pour les engins de manutention et de levage. Formation conforme aux recommandations R489, R482 et R484.',
    chapitres: [
  ...
  {
    code: 'F18-PRO', icon: '🇬🇧', titre: 'Anglais Professionnel',
    cat: 'Langues', tarif: 1200, duree: '3 mois', heures: '120h', cert: 'TOEIC 750+',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez l'anglais professionnel et obtenez le TOEIC 750+. Business English, réunions internationales, négociation et emails professionnels.',
    chapitres: [
  ...
  {
    code: 'F18-PAR', icon: '🇬🇧', titre: 'Anglais Parlé Conversationnel',
    cat: 'Langues', tarif: 700, duree: '2 mois', heures: '60h', cert: 'CECRL B2',
    cpf: true, opco: false, tp: false, domtom: true, handicap: true,
    description: 'Parlez anglais avec fluidité et confiance au niveau B2. Conversations quotidiennes, voyages, expressions idiomatiques, films et séries.',
    chapitres: [
  ...
  {
    code: 'F19-PRO', icon: '🇫🇷', titre: 'Français FLE Professionnel',
    cat: 'Langues', tarif: 1200, duree: '3 mois', heures: '120h', cert: 'DALF C1',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez le français professionnel et obtenez le DALF C1/C2. Rédaction administrative, français juridique et médical, présentations formelles.',
    chapitres: [
  ...
  {
    code: 'F20', icon: '💆', titre: 'Coaching de Vie ICF ACC',
    cat: 'Bien-être', tarif: 2800, duree: '9 mois', heures: '200h', cert: 'ICF ACC',
    cpf: true, opco: 'AFDAS', tp: false, domtom: true, handicap: true,
  ...
  {
    code: 'F21', icon: '🫶', titre: 'Médiation et CNV',
    cat: 'Bien-être', tarif: 1800, duree: '4 mois', heures: '120h', cert: 'Médiateur',
    cpf: true, opco: 'AFDAS', tp: false, domtom: true, handicap: true,
    description: 'Devenez Praticien en Communication Non Violente et Médiateur certifié. Processus CNV de Rosenberg, médiation professionnelle et expression authentique.',
    chapitres: [
  ...
  {
    code: 'F22-PRO', icon: '🇪🇸', titre: 'Espagnol Professionnel',
    cat: 'Langues', tarif: 900, duree: '3 mois', heures: '100h', cert: 'DELE B2',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez l'espagnol professionnel et obtenez le DELE B2/C1. Commerce avec l'Amérique latine, réunions et négociation avec formateur IA natif.',
    chapitres: [
  ...
  {
    code: 'F23-PRO', icon: '🇩🇪', titre: 'Allemand Professionnel',
    cat: 'Langues', tarif: 1000, duree: '3 mois', heures: '120h', cert: 'Goethe B2',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez l'allemand professionnel et obtenez la certification Goethe B2/C1. Commerce franco-allemand, réunions techniques, vocabulaire industriel.',
    chapitres: [
  ...
  {
    code: 'F24-PRO', icon: '🇨🇳', titre: 'Mandarin Professionnel',
    cat: 'Langues', tarif: 1100, duree: '5 mois', heures: '160h', cert: 'HSK 4/5',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez le mandarin professionnel et obtenez le HSK 4/5/6. Mandarin des affaires, protocole chinois, négociation avec partenaires.',
    chapitres: [
  ...
  {
    code: 'F25-PRO', icon: '🇸🇦', titre: 'Arabe Professionnel',
    cat: 'Langues', tarif: 1000, duree: '4 mois', heures: '140h', cert: 'CIPLE B1',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez l'arabe standard moderne des affaires et obtenez la certification CIPLE. Commerce avec les pays arabes, correspondance officielle, protocole culturel.',
    chapitres: [
  ...
  {
    code: 'F26-PRO', icon: '🇮🇱', titre: 'Hébreu Professionnel',
    cat: 'Langues', tarif: 900, duree: '3 mois', heures: '100h', cert: 'Ulpan avancé',
    cpf: true, opco: false, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez l'hébreu professionnel et obtenez la certification Ulpan avancé. Hébreu commercial, vocabulaire tech et startup, correspondance professionnelle.',
    chapitres: [
  ...
  {
    code: 'F27', icon: '🌙', titre: 'Hypnothérapie Clinique',
    cat: 'Bien-être', tarif: 3200, duree: '12 mois', heures: '300h', cert: 'Certifié',
    cpf: true, opco: 'AFDAS', tp: false, domtom: true, handicap: true,
    description: 'Devenez Hypnothérapeute Clinique certifié. Accompagnement thérapeutique des blocages légers, phobies, anxiété et tabac. Supervision clinique mensuelle.',
    chapitres: [
  ...
  {
    code: 'F28', icon: '🤖', titre: 'IA Générative Professionnelle',
    cat: 'IA &amp; No-Code', tarif: 1400, duree: '2 mois', heures: '80h', cert: 'RS',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez l'IA générative dans votre métier en 80 heures. Claude API, GPT-4o, Prompt Engineering avancé, agents IA et MCP Protocol.',
    chapitres: [
  ...
  {
    code: 'F29', icon: '⚙️', titre: 'Automatisations &amp; Agents IA',
    cat: 'IA &amp; No-Code', tarif: 1400, duree: '2 mois', heures: '80h', cert: 'RS',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Automatisez 10 heures de travail par semaine en 2 mois. Make Expert, n8n open source, agents autonomes et Claude API dans les workflows.',
    chapitres: [
  ...
  {
    code: 'F30', icon: '🔍', titre: 'SEO &amp; Acquisition Organique',
    cat: 'IA &amp; No-Code', tarif: 1400, duree: '2 mois', heures: '80h', cert: 'RS',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez le SEO technique et le content marketing assisté par IA pour générer un trafic organique durable.',
    chapitres: [
  ...
  {
    code: 'F31', icon: '📣', titre: 'Acquisition Google &amp; Meta Ads',
    cat: 'IA &amp; No-Code', tarif: 1400, duree: '2 mois', heures: '80h', cert: 'Google+Meta',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Devenez expert en acquisition payante Google Ads et Meta Ads. Search, Display, YouTube, Performance Max, audiences Meta, CAPI, retargeting.',
    chapitres: [
  ...
  {
    code: 'F32', icon: '💻', titre: 'Développement Applications IA',
    cat: 'IA &amp; No-Code', tarif: 1400, duree: '2 mois', heures: '80h', cert: 'RS',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Développez des applications IA complètes avec Claude API, LangChain, RAG et agents autonomes. Next.js, Supabase, Vercel.',
    chapitres: [
  ...
  {
    code: 'F33', icon: '📋', titre: 'Gestion de Projet IA',
    cat: 'IA &amp; No-Code', tarif: 1200, duree: '2 mois', heures: '60h', cert: 'RS',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
  ...
  {
    code: 'F34', icon: '🫧', titre: 'Bubble No-Code App Builder',
    cat: 'Outils', tarif: 1200, duree: '1 mois', heures: '35h', cert: 'Bubble',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez Bubble et obtenez la certification Bubble Certified Developer. Design system, data types, workflows, Stripe, API Connector et déploiement production.',
    chapitres: [
  ...
  {
    code: 'F35', icon: '🌐', titre: 'Webflow Web Design',
    cat: 'Outils', tarif: 1100, duree: '1 mois', heures: '30h', cert: 'Webflow',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Créez des sites web professionnels avec Webflow sans coder. CSS visuel, animations, CMS, e-commerce et déploiement. Certification Webflow Expert.',
    chapitres: [
  ...
  {
    code: 'F36', icon: '⚡', titre: 'Make Automatisation',
    cat: 'Outils', tarif: 1000, duree: '1 mois', heures: '30h', cert: 'Make Expert',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez Make et obtenez la certification Make Expert. Scénarios, webhooks, intégrations, Claude API, automatisation marketing et business.',
    chapitres: [
  ...
  {
    code: 'F37', icon: '🔧', titre: 'n8n Open Source',
    cat: 'Outils', tarif: 1000, duree: '1 mois', heures: '30h', cert: 'n8n Certified',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
  ...
  {
    code: 'F38', icon: '📋', titre: 'Airtable',
    cat: 'Outils', tarif: 900, duree: '1 mois', heures: '25h', cert: 'Airtable Builder',
    cpf: true, opco: false, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez Airtable comme base de données no-code et obtenez la certification Airtable Builder. Tables, vues, formules, automatisations et interfaces.',
    chapitres: [
  ...
  {
    code: 'F39', icon: '📓', titre: 'Notion &amp; IA',
    cat: 'Outils', tarif: 900, duree: '1 mois', heures: '25h', cert: 'Notion',
    cpf: true, opco: false, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez Notion comme système de gestion de la connaissance augmentée par l'IA. Bases de données, templates, Notion AI et automatisations.',
    chapitres: [
  ...
  {
    code: 'F40', icon: '🎨', titre: 'Figma UI/UX Design',
    cat: 'Outils', tarif: 1100, duree: '1 mois', heures: '30h', cert: 'Figma Pro',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez Figma pour le design UI/UX et obtenez la certification Figma Professional. Composants, prototypage, design system, Figma AI et collaboration.',
    chapitres: [
  ...
  {
    code: 'F41', icon: '✨', titre: 'Lovable Vibe Coding IA',
    cat: 'Outils', tarif: 1000, duree: '1 mois', heures: '25h', cert: 'RS',
    cpf: true, opco: false, tp: false, domtom: true, handicap: true,
    description: 'Créez des applications web complètes avec Lovable en langage naturel. Vibe coding avec IA, déploiement instantané, Supabase et intégrations API.',
    chapitres: [
  ...
  {
    code: 'F42', icon: '🖼️', titre: 'Framer Web Design',
    cat: 'Outils', tarif: 1100, duree: '1 mois', heures: '30h', cert: 'Framer Expert',
    cpf: true, opco: false, tp: false, domtom: true, handicap: true,
    description: 'Créez des sites web premium avec Framer et obtenez la certification Framer Expert. Animations avancées, CMS, composants React natifs.',
    chapitres: [
  ...
  {
    code: 'F43', icon: '💻', titre: 'Cursor Code Assisté IA',
    cat: 'Outils', tarif: 1000, duree: '1 mois', heures: '30h', cert: 'RS Dev IA',
    cpf: true, opco: true, tp: false, domtom: true, handicap: true,
    description: 'Maîtrisez Cursor comme environnement de développement assisté par IA. Chat, Composer, Agent mode, Next.js full-stack, Supabase et déploiement Vercel.',
    chapitres: [
...
function selectAll() {
  ...
  document.getElementById('btn').textContent = '✅ Sélectionné — Copiez maintenant';
}
</script>
</body>
</html>
