...
export const FORMATIONS = [
...

  {
    ...
    chapitres: [
      {
        num: 1,
        titre: 'Fondations Product Builder',
        heures: '40h',
        modules: [
          { num: 1, titre: 'Mindset Product Builder', heures: '8h', contenu: 'Vision produit · Problème vs solution · Lean Startup · Jobs to be Done · 5 étapes de validation idée' },
          ...
          { num: 4, titre: 'Validation marché', heures: '8h', contenu: 'Interviews utilisateurs · Landing page test · 50 retours · Décision go/no-go · Mirofish' },
          { num: 5, titre: 'Introduction Claude API', heures: '8h', contenu: 'API Anthropic · Premiers appels · Prompt Engineering basique · Cas d\'usage produit' },
        ],
      },
      {
        num: 2,
      ...
      },
      {
        ...
        modules: [
          ...
          { num: 4, titre: 'n8n Open Source', heures: '16h', contenu: 'Différences Make/n8n · Auto-hébergement · Cas d\'usage avancés · Optimisation coûts' },
        ],
      },
      {
        num: 4,
        titre: 'Webflow & Frontend',
        heures: '40h',
        modules: [
      ...
      {
        num: 6,
        titre: 'Product Management & Lancement',
        heures: '80h',
        modules: [
    ...
    chapitres: [
      ...
      },
      {
        ...
        modules: [
          ...
          { num: 2, titre: 'Dashboard & KPIs', heures: '30h', contenu: 'Dashboard analytics opérationnel · Suivi KPIs en temps réel · Optimisation' },
    ...
    chapitres: [
      {
        ...
        modules: [
          ...
          { num: 3, titre: 'Éthique et limites', heures: '4h', contenu: 'Biais · RGPD · Propriété intellectuelle · Fake news · Usage responsable' },
    ...
    chapitres: [
      {
        ...
        modules: [
          ...
          { num: 4, titre: 'Webhooks', heures: '5h', contenu: 'Webhook entrant/sortant · Écoute événements · Déclencheurs personnalisés' },
        ],
      },
      {
        num: 2,
      ...
      },
      {
        ...
        heures: '20h',
        modules: [
          { num: 1, titre: 'n8n vs Make', heures: '4h', contenu: 'Différences · Cas d\'usage · Self-hosting · Coûts · Migration Make → n8n' },
      ...
      },
      {
        ...
        modules: [
          ...
          { num: 2, titre: 'Zapier & alternatives', heures: '4h', contenu: 'Comparatif Make/n8n/Zapier/Activepieces · Choisir son stack' },
    ...
    chapitres: [
      {
        ...
        modules: [
          ...
          { num: 3, titre: 'Architecture LLM', heures: '8h', contenu: 'Chunking · Retrieval strategies · Évaluation LLM · Optimisation coûts API' },
        ],
      },
      {
        num: 2,
        ...
        modules: [
          ...
          { num: 3, titre: 'Évaluation & Optimisation', heures: '8h', contenu: 'Évaluation LLM · Benchmarks · Optimisation latence · Réduction coûts' },
        ],
      },
      {
        num: 3,
        titre: 'Application Production',
        heures: '28h',
        modules: [
...

  {
    ...
    chapitres: [
      {
        num: 1,
        titre: 'Fondamentaux Projet IA',
        heures: '20h',
        modules: [
          { num: 1, titre: 'Spécificités projets IA', heures: '8h', contenu: 'IA vs IT classique · Évaluation feasibility · Choix modèles · Build vs buy vs fine-tune' },
          { num: 2, titre: 'Planification', heures: '12h', contenu: 'Budget · Équipe · Roadmap · OKR · Backlog IA · Definition of Done IA' },
        ],
      },
      {
        num: 2,
        titre: 'Méthodes & Outils',
        heures: '24h',
        modules: [
      ...
      },
      {
        ...
        heures: '16h',
        modules: [
          { num: 1, titre: 'IA Act & Éthique', heures: '8h', contenu: 'IA Act européen · Éthique IA · Biais · RGPD et IA · Documentation technique' },
...

  {
    ...
    chapitres: [
      {
        num: 1,
        titre: 'Niveau 1 — Technicien en Sophrologie',
        heures: '120h',
        modules: [
      ...
      {
        num: 2,
        titre: 'Niveau 2 — Praticien en Sophrologie',
        heures: '160h',
        modules: [
      ...
      {
        num: 3,
        titre: 'Niveau 3 — Maître Praticien',
        heures: '120h',
        modules: [
...

  {
    ...
    chapitres: [
      {
        num: 1,
        titre: 'Fondamentaux de l\'Hypnose',
        heures: '80h',
        modules: [
          { num: 1, titre: 'Histoire et théories', heures: '20h', contenu: 'Histoire de l\'hypnose · Milton Erickson · Théories de l\'hypnose · États de conscience' },
          { num: 2, titre: 'Cadre éthique et légal', heures: '20h', contenu: 'Éthique et déontologie · Cadre légal · Contre-indications · Bilan pré-séance' },
      ...
      },
      {
        ...
        modules: [
          ...
          { num: 3, titre: 'Protocoles thérapeutiques', heures: '25h', contenu: 'Confiance en soi · Gestion du stress · Sommeil · Performance sportive · Phobies légères' },
...

  {
    ...
    chapitres: [
      {
        num: 1,
        titre: 'Les 9 Types de Personnalité',
        heures: '50h',
        modules: [
          { num: 1, titre: 'Histoire et origines', heures: '10h', contenu: 'Histoire de l\'Ennéagramme · 3 centres d\'intelligence · Origines traditionnelles' },
      ...
      {
        num: 3,
        titre: 'Pratique Professionnelle',
        heures: '30h',
        modules: [
          ...
          { num: 2, titre: 'Certification', heures: '15h', contenu: 'Projet professionnel · Jury certification RS · Mémoire pratique' },
        ],
      },
    ],
  },
    ...
    chapitres: [
      {
        ...
        modules: [
          ...
          { num: 2, titre: 'Alliance de coaching', heures: '20h', contenu: 'Contrat · Accord · Confiance · Présence · Sécurité psychologique · Co-création' },
      ...
      {
        num: 3,
        titre: 'Pratique Supervisée & Certification',
        heures: '60h',
        modules: [
...

  {
    ...
    chapitres: [
      ...
      {
        num: 2,
        titre: 'Médiation Professionnelle',
        heures: '50h',
        modules: [
          ...
          { num: 2, titre: 'Techniques de médiation', heures: '20h', contenu: 'Écoute active · Gestion des émotions fortes · Médiations familiale · professionnelle · commerciale' },
...

  {
    ...
    domtom: true,
    handicap: true,
    description: 'Devenez Hypnothérapeute Clinique certifié. Accompagnement thérapeutique des blocages légers, phobies, anxiété et tabac. Supervision clinique mensuelle et 150 séances pratiques.',
    chapitres: [
      {
        num: 1,
        titre: 'Fondamentaux Hypnothérapie Clinique',
        heures: '80h',
        modules: [
          { num: 1, titre: 'Neurobiologie de l\'hypnose', heures: '20h', contenu: 'Neurobiologie · États de conscience modifiés · Différences hypnose Ericksonienne et clinique' },
          { num: 2, titre: 'Évaluation clinique', heures: '20h', contenu: 'Bilan psychologique · Contre-indications · Éthique clinique · Cadre légal strict' },
      ...
      {
        num: 3,
        titre: 'Pratique Clinique Supervisée',
        heures: '100h',
        modules: [
          { num: 1, titre: 'Séances cliniques supervisées', heures: '60h', contenu: '150 séances supervisées · Supervision clinique mensuelle · Études de cas complexes' },
...

  {
    ...
    chapitres: [
      ...
      {
        num: 2,
        titre: 'Sécurité Systèmes & Applications',
        heures: '80h',
        modules: [
      ...
      {
        num: 4,
        titre: 'SOC & Gestion des Incidents',
        heures: '60h',
        modules: [
      ...
      {
        num: 5,
        titre: 'Préparation Certifications',
        heures: '20h',
        modules: [
...

  {
    ...
    chapitres: [
      ...
      {
        num: 3,
        titre: 'Mise en Œuvre & Certification',
        heures: '20h',
        modules: [
          ...
          { num: 2, titre: 'Projet RSE & Certification', heures: '10h', contenu: 'Rapport annuel RSE · Projet RSE complet pour une organisation · Certification ISO 26000' },
        ],
      },
    ],
  },
...

  {
    ...
    chapitres: [
      {
        num: 1,
        titre: 'Fondamentaux Agile & Scrum',
        heures: '30h',
        modules: [
    ...
    chapitres: [
      ...
      },
      {
        ...
        modules: [
          ...
          { num: 2, titre: 'Business Plan et budget', heures: '30h', contenu: 'Business plan · Budget · Prévisionnel · Valorisation d\'entreprise · Financement · Levée de fonds' },
...

  {
    ...
    domtom: true,
    handicap: true,
    description: 'Développez vos compétences comportementales et votre intelligence émotionnelle certifiées RS IE. Communication, leadership, gestion du stress et prise de décision.',
    chapitres: [
      {
        num: 1,
      ...
      {
        num: 2,
        titre: 'Communication & Leadership',
        heures: '30h',
        modules: [
      ...
      {
        num: 3,
        titre: 'Gestion du Stress & Certification',
        heures: '15h',
        modules: [
          { num: 1, titre: 'Gestion du stress', heures: '10h', contenu: 'Identification stresseurs · Techniques gestion stress · Mindfulness · Créativité · Prise de décision' },
    ...
    chapitres: [
      {
        ...
        modules: [
          ...
          { num: 2, titre: 'Exploration et synthèse', heures: '20h', contenu: 'Valeurs et motivations · Exploration métiers · Marché de l\'emploi · Enquêtes métier · Synthèse' },
        ],
      },
      {
        num: 2,
        titre: 'VAE & Projet Professionnel',
        heures: '30h',
        modules: [
          { num: 1, titre: 'Processus VAE', heures: '15h', contenu: 'Recevabilité · Livrets 1 et 2 · Constitution du dossier · Préparation jury VAE' },
          { num: 2, titre: 'Plan de développement', heures: '15h', contenu: 'Plan de développement professionnel · CV · LinkedIn optimisé · Stratégie recherche d\'emploi' },
        ],
      },
    ],
  },

  {
    ...
    chapitres: [
      ...
      {
        num: 3,
        titre: 'CACES R482 & R484',
        heures: '60h',
        modules: [
          { num: 1, titre: 'CACES R482 Engins de chantier', heures: '35h', contenu: 'Catégories A-G · Technologie · Manœuvres · Tests théoriques · Exercices pratiques' },
...

  {
    ...
    chapitres: [
      ...
      {
        num: 3,
        titre: 'Préparation TOEIC',
        heures: '30h',
        modules: [
          { num: 1, titre: 'Entraînement TOEIC', heures: '20h', contenu: '3000 questions TOEIC · Stratégies · Listening Comprehension · Reading Comprehension · Grammaire' },
...

  {
    ...
    chapitres: [
      ...
      {
        num: 2,
        titre: 'Fluidité & Certification B2',
        heures: '30h',
        modules: [
          { num: 1, titre: 'Expressions et culture', heures: '20h', contenu: 'Idiomes · Expressions populaires · Humour britannique et américain · Films sans sous-titres · Slang' },
...

  {
    ...
    chapitres: [
      ...
      {
        num: 3,
        titre: 'Préparation DALF',
        heures: '30h',
        modules: [
          { num: 1, titre: 'Entraînement DALF', heures: '20h', contenu: '500 exercices DALF · Compréhension écrite et orale · Production écrite et orale · Stratégies' },
    ...
    chapitres: [
      ...
      },
      {
        ...
        modules: [
          ...
          { num: 2, titre: 'Préparation DELE', heures: '15h', contenu: 'Révisions DELE B2/C1 · Simulations · Certification DELE officielle' },
        ],
      },
    ],
  },
    ...
    chapitres: [
      ...
      },
      {
        ...
        modules: [
          ...
          { num: 2, titre: 'Certification Goethe', heures: '15h', contenu: 'Hörverstehen · Leseverstehen · Schreiben · Sprechen · Certification Goethe B2/C1' },
        ],
      },
    ],
  },

  {
    ...
    chapitres: [
      {
        num: 1,
        titre: 'Fondamentaux Mandarin',
        heures: '60h',
        modules: [
          { num: 1, titre: 'Pinyin et caractères', heures: '20h', contenu: 'Pinyin · Tons · Caractères simplifiés · Écriture · Prononciation · Sons difficiles' },
          ...
          { num: 3, titre: 'Culture chinoise', heures: '20h', contenu: 'Culture chinoise · Étiquette sociale · Guanxi · Protocole · Contexte historique' },
        ],
      },
      {
        num: 2,
        titre: 'Mandarin des Affaires',
        heures: '60h',
        modules: [
          { num: 1, titre: 'Vocabulaire business', heures: '25h', contenu: 'Vocabulaire business · Protocole et étiquette · Négociation · Correspondance professionnelle' },
      ...
      {
        num: 3,
        titre: 'Certification HSK',
        heures: '40h',
        modules: [
          { num: 1, titre: 'Préparation HSK', heures: '25h', contenu: 'Vocabulaire HSK · Exercices écoute · Lecture · Écriture · Stratégies d\'examen' },
          { num: 2, titre: 'Certification HSK', heures: '15h', contenu: 'Simulations · Certification HSK 4/5/6 officielle · Équivalences CECRL' },
        ],
      },
    ],
  },

  {
    ...
    chapitres: [
      {
        num: 1,
        titre: 'Arabe Standard Moderne',
        heures: '60h',
        modules: [
          { num: 1, titre: 'Alphabet et bases', heures: '25h', contenu: 'Alphabet arabe · Écriture et prononciation · Grammaire fondamentale · Vocabulaire essentiel' },
          { num: 2, titre: 'Compréhension', heures: '35h', contenu: 'Arabe standard vs dialectes · Écoute presse arabe · Al Jazeera · Lecture documents officiels' },
        ],
      },
      {
        num: 2,
        titre: 'Arabe des Affaires',
        heures: '50h',
        modules: [
...

  {
    ...
    chapitres: [
      {
        num: 1,
        titre: 'Hébreu Fondamentaux',
        heures: '40h',
        modules: [
          { num: 1, titre: 'Alphabet et bases', heures: '20h', contenu: 'Alphabet hébreu · Écriture et prononciation · Grammaire · Vocabulaire essentiel' },
      ...
      {
        num: 2,
        titre: 'Hébreu Professionnel & Certification',
        heures: '60h',
        modules: [
...

  {
    ...
    domtom: true,
    handicap: true,
    description: 'Maîtrisez Bubble et obtenez la certification Bubble Certified Developer. Design system, data types, workflows, Stripe, API Connector et déploiement production en 35 heures.',
    chapitres: [
      {
        num: 1,
        titre: 'Bubble Fondamentaux',
        heures: '15h',
        modules: [
      ...
      {
        num: 2,
        titre: 'Bubble Avancé & Certification',
        heures: '20h',
        modules: [
...

  {
    ...
    chapitres: [
      ...
      {
        num: 2,
        titre: 'Webflow Avancé & Certification',
        heures: '15h',
        modules: [
...

  {
    ...
    { num: 2, titre: 'Intégrations essentielles', heures: '7h', contenu: 'Gmail · Sheets · Airtable · Slack · Notion · Webhooks entrant/sortant · Scheduling' },
     ...
     {
       num: 2,
       titre: 'Make Avancé & Certification',
       heures: '15h',
       modules: [
...

 {
   ...
   chapitres: [
     ...
     {
       num: 2,
       titre: 'n8n Avancé & Certification',
       heures: '15h',
       modules: [
         { num: 1, titre: 'Agents IA avec n8n', heures: '8h', contenu: 'AI Agent node · Mémoire agents · Chat trigger · Long-running workflows · Migration Make → n8n' },
...

 {
   ...
   chapitres: [
     ...
     {
       num: 2,
       titre: 'Airtable Avancé & Certification',
       heures: '13h',
       modules: [
...

 {
   ...
   domtom: true,
   handicap: true,
   description: 'Maîtrisez Figma pour le design UI/UX et obtenez la certification Figma Professional. Composants, prototypage, design system, Figma AI et collaboration d\'équipe.',
   chapitres: [
     {
       num: 1,
       titre: 'Figma Fondamentaux',
       heures: '15h',
       modules: [
     ...
     {
       num: 2,
       titre: 'Figma Avancé & Certification',
       heures: '15h',
       modules: [
...

 {
   ...
   chapitres: [
     ...
     {
       num: 2,
       titre: 'Lovable Avancé & Certification',
       heures: '13h',
       modules: [
...

 {
   ...
   chapitres: [
     ...
     {
       num: 2,
       titre: 'Framer Avancé & Certification',
       heures: '15h',
       modules: [
...

 {
   ...
   chapitres: [
     ...
     {
       num: 2,
       titre: 'Cursor Avancé & Certification',
       heures: '15h',
       modules: [
