...
export const FORMATIONS = [
  ...
  },
  {
    ...
    description: 'Devenez Praticien en Sophrologie Caycédienne certifié RS. 400 heures sur 3 niveaux progressifs. Supervision mensuelle et jury de certification.',
    chapitres: [
