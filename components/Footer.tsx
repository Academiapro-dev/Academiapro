...
const Footer: React.FC = () => {
  ...
  const formations = [
    ...
    "Automatisation & No-Code AI",
    "Leadership & IA Stratégique",
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent 0%, #c8a96e 30%, #e8c97e 50%, #c8a96e 70%, transparent 100%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center top, rgba(200,169,110,0.08) 0%, transparent 70%)",
        }}
      />
          ...
          <div className="lg:col-span-1 flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #c8a96e 0%, #e8c97e 50%, #a07840 100%)",
