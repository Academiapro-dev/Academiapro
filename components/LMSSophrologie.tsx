...
GITHUB_TOKEN = "REMPLACE_PAR_TON_TOKEN"
REPO = "Academiapro-dev/Academiapro"
PATH = "app/formation/[id]/page.tsx"

contenu = r'''"use client";
...
b64 = base64.b64encode(contenu.encode("utf-8")).decode("utf-8")
payload = {
    "message": "Fix: formation page v2 avec LMSSophrologie",
    "content": b64,
    "sha": sha
}

r = requests.put(url, headers=headers, json=payload)
print(r.status_code, r.json().get("commit", {}).get("sha", r.text[:100]))
