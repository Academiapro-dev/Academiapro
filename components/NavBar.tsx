...
//
// La banniere Mr CRM, deposee dans public/ le 03/09 puis RECADREE le meme
// soir : le logo etait centre dans l image, il occupe desormais le premier
// tiers, comme sur Mr LMS et MysterLLC. Une banniere dont le sujet est
// centre laisse un grand vide a droite dans une barre alignee a gauche.
//
// ⚠️ LE FICHIER S APPELLE « mrcrm-banniere.png », SANS ESPACE ni double
// extension — contrairement a la premiere version deposee et a celles de
// Mr LMS. Verifier le nom reel avant de le changer.
