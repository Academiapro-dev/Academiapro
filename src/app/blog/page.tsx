...
const ARTICLES = [
  ...
  { slug: 'cybersecurite-comptia-6-mois', titre: 'Cybersécurité : de débutant à certifié CompTIA Security+ en 6 mois', cat: 'Cybersécurité', date: '13 mai 2026', duree: '9 min', icon: '🔐', desc: '400 000 postes non pourvus en Europe. Le guide pour décrocher la certification CompTIA Security+ en 6 mois.' },
  ...
  { slug: 'bootcamp-no-code-5900-euros', titre: 'Bootcamp No-Code 2026 — Vaut-il vraiment 5 900 EUR ?', cat: 'Formations', date: '13 mai 2026', duree: '9 min', icon: '🏗️', desc: 'Le calcul honnête du ROI. Pour certains profils : 5 900 EUR remboursé en 2 jours de freelance. Ce guide vous aide à décider.' },
  ...
  { slug: 'toeic-750-3-mois', titre: 'TOEIC 750+ en 3 mois — La méthode avec un formateur IA natif', cat: 'Langues', date: '1 avril 2026', duree: '6 min', icon: '🇬🇧', desc: 'Le TOEIC 750+ ouvre les postes internationaux. Un formateur IA natif disponible 24h/24 change tout.' },
  { slug: 'certification-coach-icf-2026', titre: 'Se certifier coach professionnel ICF en 2026 — Le guide complet', cat: 'Coaching', date: '25 mars 2026', duree: '9 min', icon: '💆', desc: 'Le marché du coaching pèse 1 milliard d\'euros. La certification ICF est la seule vraiment reconnue dans 140 pays.' },
  { slug: 'automatisations-make-5-scenarios', titre: 'Automatisez 10 heures par semaine avec Make — 5 scénarios concrets', cat: 'Automatisation', date: '18 mars 2026', duree: '8 min', icon: '⚙️', desc: '5 scénarios Make que vous pouvez mettre en place ce week-end.' },
  { slug: 'csrd-rse-formation-2026', titre: 'CSRD 2026 — Tout comprendre sur la nouvelle obligation RSE', cat: 'RSE', date: '11 mars 2026', duree: '8 min', icon: '🌱', desc: '50 000 entreprises concernées dès 2026. Le rôle de Référent RSE explose. +45% d\'offres d\'emploi RSE en 2 ans.' },
]
    ...
    <>
      <main style={{ paddingTop: 64 }}>
        ...
        <section style={{ padding: '48px 6% 60px' }}>
          ...
          <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 20, padding: 40, marginBottom: 32, position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, alignItems: 'center' }}>
              <div>
                ...
                <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
                  <Link href={`/blog/${ARTICLES[0].slug}`} style={{ padding: '10px 24px', borderRadius: 10, background: 'var(--gold)', color: '#050508', fontWeight: 700, textDecoration: 'none', fontSize: 13 }}>Lire l'article →</Link>
              ...
              <div style={{ background: 'var(--s2)', borderRadius: 16, padding: 28, border: '1px solid var(--border)', textAlign: 'center' }}>
                ...
                <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 24, color: 'var(--gold)', fontWeight: 700 }}>{ARTICLES[0].cat}</div>
                <div style={{ fontSize: 13, color: 'var(--dim)', marginTop: 8 }}>Guide complet · {ARTICLES[0].duree} de lecture</div>
              </div>
            </div>
          </div>
        ...
        <section style={{ padding: '60px 6%', textAlign: 'center', background: 'var(--s1)', borderTop: '1px solid var(--border)' }}>
          ...
          <div style={{ display: 'flex', gap: 10, justifyContent: 'center', maxWidth: 420, margin: '0 auto' }}>
            ...
            <button style={{ padding: '12px 22px', borderRadius: 10, background: 'var(--gold)', border: 'none', cursor: 'pointer', color: '#050508', fontSize: 13, fontWeight: 700 }}>S'abonner →</button>
          </div>
        </section>
